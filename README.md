...
| TumblrShareButton            | -                                                                                           | **`title`** (string): Title of the shared page<br/>**`tags`**: (`Array<string>`)<br/>**`caption`** (string): Description of the shared page<br/>**`posttype`** (string, default=`link`): See <a href="https://help.tumblr.com/knowledge-base/share-button-documentation/">Tumblr documentation</a><br/>**`content`** (string): The content for some post types                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
